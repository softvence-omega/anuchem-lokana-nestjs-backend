...
export class AuthController {
  ...
  async login(@Body() loginAuthDto: LoginAuthDto) {
    ...
    return sendResponse('Login successfull!', result);
  }
  ...
  async register(@Body() payload: RegisterAuthDto) {
    ...
    return sendResponse('Registration successfull!', result);
  }
  ...
  async forgetPassword(@Body() payload: ForgetPasswordAuthDto) {
    ...
    return sendResponse('Email sent successfully!', result);
  }
  ...
  async verifyOtp(@Body() payload: VerifyOtpAuthDto) {
    ...
    return sendResponse('OTP verified successfully!', result);
  }
  ...
  async resetPassword(@Body() payload: ResetPasswordAuthDto) {
    ...
    return sendResponse('Password was reset successfully!', result);
  }
  ...
  async changePassword(@Req() req, @Body() payload: ChangePasswordAuthDto) {
    ...
    return sendResponse('Password updated successfully!', result);
  }
  ...
  async delete(@Req() req) {
    ...
    return sendResponse('Account deleted successfully!', result);
  }
}
